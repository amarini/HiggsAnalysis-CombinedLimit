...
EIGEN = /cvmfs/cms.cern.ch/slc7_amd64_gcc820/external/eigen/d812f411c3f9-bcolbf2/
# Compiler and flags -----------------------------------------------------------
CC = c++
...
CCFLAGS = -D STANDALONE $(ROOTCFLAGS) -I$(BOOST)/include -I$(VDT)/include -I$(GSL)/include -g -fPIC -I$(EIGEN)/include/eigen3
