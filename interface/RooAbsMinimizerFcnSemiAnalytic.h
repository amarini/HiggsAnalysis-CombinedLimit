...
#ifndef ROO_ABS_MINIMIZER_FCN_SEMIANALYTIC
#define ROO_ABS_MINIMIZER_FCN_SEMIANALYTIC
...
class RooAbsMinimizerFcnSemiAnalytic {

public:
   RooAbsMinimizerFcnSemiAnalytic(RooArgList paramList, RooMinimizerSemiAnalytic *context, bool verbose = false);
   RooAbsMinimizerFcnSemiAnalytic(const RooAbsMinimizerFcnSemiAnalytic &other);
   virtual ~RooAbsMinimizerFcnSemiAnalytic() = default;
